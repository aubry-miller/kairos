...
<body class="main">
    ...
    ?>  
    <h4 class="fs-xl fw-medium lh-1 mt-3 mb-6"><?php echo trad('grinding_workshop',$_SESSION["language"]);?></h4>
    <div class="content">
        <?php
        $v=0;
        foreach($days as $day){
                        ...
                        <div class="intro-y box">
                            ...
                            <div id="boxed-accordion" class="p-5">
                                <div class="preview">
                                    ...
                                    <?php
                                        //selection des commandes du jour pour le rectif
                                        $jobs=select_jobs_by_day_and_step_id($day, '4');
                                        foreach($jobs as $job){
