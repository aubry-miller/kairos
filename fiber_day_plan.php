                    ...
                    <div class="p-5 border-bottom border-gray-200 dark-border-dark-5">
                        ...
                        <div class="overflow-x-auto">
                            <table class="table mt-40">
                                ...
                                <tbody>
                                    <?php
                                    $jobs=select_jobs_by_day_and_step_id($date, '1');
                                    ?>
                                    <?php
                                    foreach($jobs as $job){
                                        if($job['pt_status'] != "Finished"){?>
                                        
                                            <tr onclick="document.location='do_job.php?plan_id=<?php echo $job['pt_id'];?>&piece=<?php echo $job['pc_id'].'&step=1';?>'" class="plan_table">
                                                <td>
                                                    <?php echo $job['pc_id'];?>
                                                </td>
                                                <td>
